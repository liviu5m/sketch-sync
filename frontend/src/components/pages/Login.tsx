      ...
      <div className="border border-slate-700 bg-[#162033] rounded-2xl p-10 w-[500px] flex items-center justify-center flex-col gap-6 shadow">
        ...
        <form className="flex flex-col gap-4 w-full" onSubmit={(e) => {
          ...
          <button
            type="submit"
            disabled={isPending}
            className="bg-[#FF6B6B] text-white font-semibold py-2 rounded-2xl cursor-pointer hover:scale-105 hover:bg-[#f84a4a]"
          >
            Log in
          </button>
        </form>
        ...
        <p className="text-slate-400">
          ...
          <Link className="text-slate-300 font-semibold" to="/auth/signup">
            Sign Up
          </Link>
        </p>
      </div>
